...
# API_URL="http://127.0.0.1:5000/api/v1/student-overall-evaluations?orderByCol=id&orderByAsc=true&show_active_data=true&paginate=10&page=0
# response=$(curl -s "$API_URL")
...
echo ""
echo student overall evaluations seed start"
API_URL="http://127.0.0.1:5000/api/v1/student-evaluation-criterias?orderByCol=id&orderByAsc=true&show_active_data=true&paginate=10&page=0
response=$(curl -s "$API_URL")
